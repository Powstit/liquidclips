  ...
  return (
    <div className="flex w-full max-w-[1080px] flex-col gap-6">
      <header className="flex flex-col gap-1">
        ...
        {/* v0.7.76 — Tightened payout-source honesty. Whop pays direct for
            reward campaigns; Liquid Clips only pays Stripe-Connect affiliate
            commissions. Pre-fix the "your money, one place" headline read
            like Liquid Clips held the funds — first-time clippers asked
            where the "Withdraw" button was. */}
        <p className="font-sans text-[13px] leading-snug text-text-secondary">
          Whop pays you direct for reward campaigns. Liquid Clips pays
          affiliate commissions via Stripe Connect.
        </p>
      </header>
        ...
        {signedOut ? (
          <Card padding="md" className="border-dashed">
            <p className="font-sans text-[13px] text-ink">
              Connect your Whop account to see payouts and earnings.
            </p>
            <button
              type="button"
          ...
          <Card padding="md" className="flex flex-wrap items-center gap-3 border-[#DC2626]/40 bg-[#DC2626]/10">
            ...
            <button
              ...
              className="btn-secondary px-3 py-1 font-mono text-[10px] uppercase tracking-[var(--tracking-eyebrow)]"
            >
          ...
          <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
            ...
            <MoneySourceCard
              ...
              setupUrl={
                ...
                "https://account.liquidclips.app/dashboard#payouts"
              }
            />
          </div>
        )}
