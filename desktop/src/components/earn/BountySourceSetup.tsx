                ...
                >
                  ...
                  {src.supported ? (
                    <button
                      ...
                      className="shrink-0 rounded-full bg-fuchsia px-4 py-2 font-sans text-[13px] font-medium text-ink transition-all hover:bg-fuchsia-bright hover:shadow-[0_10px_30px_rgba(255,26,140,0.3)]"
                    >
                      Use this source →
                    </button>
                  ) : (
