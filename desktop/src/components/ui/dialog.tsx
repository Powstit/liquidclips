...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      "font-sans text-[15px] font-semibold tracking-[-0.01em] text-paper",
      className,
    )}
    {...props}
  />
