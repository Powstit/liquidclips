 ...
 *
 * Ported from desktop-2 for the legacy desktop/ shell. Dropped the
 * GlassCard wrapper (no GlassCard primitive in desktop/) in favour of a
 * plain div that inherits the .lc-wallet-stat styles directly.
 */
