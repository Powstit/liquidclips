...
type SettingsCategory = "account" | "connections" | "keys" | "notifications" | "diagnostics" | "about";
    ...
    <div className="fixed inset-0 z-50 flex justify-end bg-ink/40" onClick={onClose}>
      ...
      >
        ...
        <div className="flex min-h-0 flex-1 flex-row">
          ...
          {category === "diagnostics" && <SupportSection />}
...
function SettingsLeftRail({
  ...
  const items: SettingsCategory[] = ["account", "connections", "keys", "notifications", "diagnostics", "about"];
  return (
    <nav
