...
const faqs = [
  {
    ...
    a: "You can use the desktop app to cut clips without Whop — Free, Solo, and Growth tiers all work on direct sign-in. But Whop is the layer that connects you to content-reward campaigns, so to earn from brand briefs you need a Whop account linked to the desktop app.",
  },
  {
  ...
  },
  {
    ...
    a: "Free. The desktop download is free, the Whop account is free to create, and content-reward campaigns are paid by the brand — clippers never pay to submit. If you want unlimited exports per month or hosted AI scoring, the Solo and Growth tiers are on the pricing page.",
  },
  {
    q: "Mac only?",
