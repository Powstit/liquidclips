    ...
    <ClerkProvider
      appearance={{
        ...
        elements: {
          ...
          headerTitle: "font-display tracking-[-0.025em] text-[#f4f1ea]",
          headerSubtitle: "text-[#c8c4be]",
          formButtonPrimary: "bg-fuchsia hover:bg-fuchsia-bright transition-colors",
          // 2026-08-20 — mirrors account-app's fix. colorForeground/
          // colorMutedForeground don't reach every element's text color in
          // Clerk v7; several fall back to Clerk's own dark default,
          // invisible against our dark card. Explicit overrides so nothing
          // goes dark silently.
