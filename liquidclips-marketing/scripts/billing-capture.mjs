...
const browser = await puppeteer.launch({
  ...
  args: [
    ...
    "--user-data-dir=/tmp/puppeteer-bl",
    "--no-first-run",
...
if (items[3]) {
  ...
  await page.screenshot({ path: `${OUT}/billing-1-tiers.png` });
  console.log("ok · billing-1-tiers.png");
  ...
  await page.screenshot({ path: `${OUT}/billing-2-math.png` });
  console.log("ok · billing-2-math.png");
}
