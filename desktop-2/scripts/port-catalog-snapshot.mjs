...
const RECEIPT = '/Users/dipdip/code/jnr/08_receipts/port-catalog-carousel';
mkdirSync(RECEIPT, { recursive: true });
const MOCKUP = '/Users/dipdip/Desktop/liquidclips-marketing-hq-v2/05_html-mockups/approved/catalog-carousel.html';
...
const STATES = ['ready', 'loading', 'partial', 'empty', 'error', 'focused'];
