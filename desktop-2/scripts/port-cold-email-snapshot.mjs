...
const RECEIPT = '/Users/dipdip/code/jnr/08_receipts/port-cold-email-preview-embed-card';
mkdirSync(RECEIPT, { recursive: true });
const MOCKUP = '/Users/dipdip/Desktop/liquidclips-marketing-hq-v2/05_html-mockups/approved/cold-email-preview-embed-card.html';
...
const STATES = ['populated','loading','critical_countdown','already_settled','expired','empty_catalog','offline'];
