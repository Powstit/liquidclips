...
const RECEIPT = '/Users/dipdip/code/jnr/08_receipts/port-cancellation-intercept';
mkdirSync(RECEIPT, { recursive: true });
const MOCKUP = '/Users/dipdip/Desktop/liquidclips-marketing-hq-v2/05_html-mockups/approved/cancellation-intercept.html';
...
const STATES = ['cancel-attempt', 'paused-then-back', 'already-cancelled'];
