...
// Lift-and-shift from `desktop/src-tauri/src/sidecar.rs` (Batch A · 2026-06-20).
// The JSON-RPC framing, restart-cap, structured error envelope, and event
// re-emit shape are FROZEN. Any change must update the gate entry in
// `desktop/docs/IRON_GATES.md` and the matching wrapper in
// `desktop-2/src/design-os/engine/sidecar-stub.ts` (Batch B target).
//
