...
| mo-10 | money/mo-10/earn-summary | pending | self-review PASS | 2026-07-06 | C1 | WalletPanel split into <Watchdog><WalletPanelBody/></Watchdog> · wraps all three render branches (loading · offline · loaded) with a single boundary · recent_ledger via WalletActivityFeed is child of body so mo-12 shares |
| mo-12 | money/mo-10/earn-summary (shared) | pending | self-review PASS | 2026-07-06 | C1 | recent_ledger renders via WalletActivityFeed inside WalletPanelBody · coverage inherited from mo-10 wrap · no separate node |
