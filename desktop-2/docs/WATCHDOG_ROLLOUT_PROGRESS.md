...
| mo-06 | money/mo-06/calendar-view | pending | self-review PASS | 2026-07-06 | C1 | ScheduleRoute root wrapped · nested inside EngineSessionProvider · co-exists with C-agency's ag-15 cap-tag wrap in the same file (no double-cover · different subtrees) |
