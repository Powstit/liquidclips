...
| mo-09 | money/mo-09/reward-clip-statuses | pending | self-review PASS | 2026-07-06 | C1 | RewardClipDrawer loaded-state wrap · covers status stamp + timeline + tracking link block (mo-19 shares this wrap) |
| mo-19 | money/mo-09/reward-clip-statuses (shared) | pending | self-review PASS | 2026-07-06 | C1 | Tracking-link block renders inline inside RewardClipDrawer.tsx:190-207; coverage inherited from mo-09 wrap · no dedicated TrackingLinkDisplay component exists to wrap separately |
