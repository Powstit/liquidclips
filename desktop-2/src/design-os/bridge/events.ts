...
export type LCEvents = {
  ...
  "engine:complete": {
    ...
    project?: unknown;
    /** 2026-07-29 · for kind:"bake" only — true when this is the LAST
     ...
     *  useComposerBrain) must set this so useEngineSession doesn't
     *  treat every stage as pipeline completion. Omitted = final, for
     *  emit sites that only ever fire once. */
    final?: boolean;
  };
