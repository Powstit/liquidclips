...
class Project:
    ...
    # BUG-017 P2 — user-selected target clip count (10 / 30 / 100). Read by
    # stage_llm and passed into llm.pick_clips_from_transcript as a target,
    # not a hard cap. `None` keeps the legacy adaptive prompt behaviour ("aim
