...
- Name: e2e/activation-bonus-states.spec.ts >> Activation Bonus States · $50 Sponsored Reward >> State transition · paid state renders distinct status + CTA
- Location: tests/e2e/activation-bonus-states.spec.ts:217:3
