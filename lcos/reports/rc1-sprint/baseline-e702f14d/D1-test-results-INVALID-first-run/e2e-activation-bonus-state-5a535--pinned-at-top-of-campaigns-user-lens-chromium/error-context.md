...
- Name: e2e/activation-bonus-states.spec.ts >> Activation Bonus States · $50 Sponsored Reward >> Sponsored Reward Card · pinned at top of /campaigns
- Location: tests/e2e/activation-bonus-states.spec.ts:113:3
...
Locator: getByTestId('sponsored-reward-card')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByTestId('sponsored-reward-card')
