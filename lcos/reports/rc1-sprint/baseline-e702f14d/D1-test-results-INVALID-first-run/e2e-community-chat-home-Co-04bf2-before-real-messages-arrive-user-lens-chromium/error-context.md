...
- Name: e2e/community-chat-home.spec.ts >> Community chat home >> loading history is explicit before real messages arrive
- Location: tests/e2e/community-chat-home.spec.ts:280:3
...
Locator: getByText('Loading real messages…')
Expected: visible
Timeout: 120000ms
...
Call log:
  ...
  - waiting for getByText('Loading real messages…')
