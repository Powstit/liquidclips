...
const GROUPS: Group[] = [
  {
    ...
    rows: [
      ...
      { label: "Hosted transcribe (optional — local is default)", free: false, solo: false, growth: "Beta", autopilot: "Beta" },
      { label: "Hosted LLM (no OpenAI key needed)",         free: false,  solo: false,  growth: "Beta", autopilot: "Beta" },
  ...
  },
  {
    heading: "Publishing",
    rows: [
      { label: "Publish to YouTube Shorts",                 free: false,  solo: "Beta", growth: "Beta", autopilot: "Beta" },
      { label: "Publish to TikTok",                         free: false,  solo: "Beta", growth: "Beta", autopilot: "Beta" },
      { label: "Publish to Instagram Reels",                free: false,  solo: "Beta", growth: "Beta", autopilot: "Beta" },
      { label: "Publish to X (Twitter)",                    free: false,  solo: "Beta", growth: "Beta", autopilot: "Beta" },
      { label: "Multi-platform in one click",               free: false,  solo: false,  growth: "Beta", autopilot: "Beta" },
  ...
  },
  {
    heading: "Scheduling",
    rows: [
      { label: "Schedule one post",                         free: false,  solo: false,  growth: "Beta", autopilot: "Beta" },
      { label: "Schedule across YouTube + TikTok + X",      free: false,  solo: false,  growth: "Beta", autopilot: "Beta" },
      { label: "14-day auto-drip across all platforms",     free: false,  solo: false,  growth: false, autopilot: "Beta" },
      { label: "Cron fires while laptop is closed",         free: false,  solo: false,  growth: "Beta", autopilot: "Beta" },
