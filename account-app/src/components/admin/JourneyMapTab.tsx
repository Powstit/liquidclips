...
const JOURNEYS: Journey[] = [
  // ── Identity + access (12) ──
  { id: "id-01", cluster: "identity", name: "First-launch intro splash → free-tier shell", status: "wired", citation: "desktop-2/src/App.tsx:220", note: "IntroSplash gate + localStorage/keychain JWT cold-boot. Wrapped in Watchdog identity/id-01/intro-splash (2026-07-06) — crash renders KadeRepairScreen fallback instead of white-screen; failure dispatches to HQ Admin intercession bus." },
