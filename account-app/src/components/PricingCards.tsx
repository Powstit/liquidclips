...
const PLANS: Plan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { label: "One-click publish — one platform at a time", built: false, sprint: "Beta" },
    ],
  },
  {
    ...
    slug: "growth",
    name: "Growth",
    tagline: "Higher limits and faster local processing.",
    priceUsd: 99.99,
    features: [
      { label: "Everything in Solo", built: true },
      { label: "Faster on-device processing", built: true },
  ...
  },
  {
    ...
    slug: "autopilot",
    name: "Autopilot",
    tagline: "The highest limits and priority support.",
    priceUsd: 199.99,
    features: [
